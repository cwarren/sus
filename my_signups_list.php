...
//    1. all the sign-ups the user has made, as a list, ordered from oldest to newest, one's before the present are hidden
//    2. all sign-ups by others on sheets the user owns or admins
...
echo "<div id=\"toggle_my_past_display\">Show Past Sign-ups</div>\n";
...
?>
 ...
 <div class="tabbertab" title="Sign-ups On My Sheets">
<?php
$signups_for_me = getSignupsForSheetsOf($USER->id,$USER->username,$now);

echo "<div id=\"toggle_for_me_past_display\">Show Past Sign-ups</div>\n";
...
if (! $signups_for_me)
{
    echo "There are no sign-ups on sheets owned or administrated by you.";
} else
{
...
{
  var toggle_text_my_future = "Hide Past Sign-ups";
  var toggle_text_my_cur = "Show Past Sign-ups";
  var toggle_text_for_me_future = "Hide Past Sign-ups";
  var toggle_text_for_me_cur = "Show Past Sign-ups";
  ...
  $("#toggle_my_past_display").click(function(evt) {
    ...
    if (toggle_text_my_cur == "Hide Past Sign-ups")
    {
      $(".my_in_past").show();
    } else
    {
  ...
  $("#toggle_for_me_past_display").click(function(evt) {
    ...
    if (toggle_text_for_me_cur == "Hide Past Sign-ups")
    {
      $(".for_me_in_past").show();
    } else
    {
